-- /* File list9_2.lua */ -- Data fitting and 6 plots for Figure 9.1
...
c = {1,2,100}; nc = #c -- Initial guess at coefficients
...
write_data('list9_2.dat',xd,yd,ycalc,res,yres1,yres2,xp,yp,ypn,xl,yl,xh,yh,yhn)
-- Now show 6 plots
...
nr,prb = runs(res)
print('Prob of observed '..nr..' runs is '..engr(100*prb,'%'))
