-- /* File list9_20.lua */ -- Data fitting, Parameter estimation
...
ft = function(x,c) -- Define function to fit data
	...
	return c[1]*(vgt*vdx - 0.5*vdx^2)*(1 + c[3]*vd) - x[1]
end

c = {1.e-4,.20,0.01};nc = #c
step = {2,2,5}
...
write_data(infile..'a.dat',id,vd,vg,ycalc)
plot(vd,id,ycalc)
