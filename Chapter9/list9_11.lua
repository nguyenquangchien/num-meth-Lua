-- /* File list9_11.lua */ -- General file for data fitting, Parameter estimation 
...
ft = function(x,c) -- Define function to fit data
	return  c[1]/(c[2] + x[2]) - x[1]
end
c = {-3000,50}; nc = #c -- Initial approximations. End of changes for most data sets
