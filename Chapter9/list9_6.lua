-- /* File list9_6.lua */ -- General file for data fitting, Parameter estimation 
...
ft = function(x,c) -- Define function to fit data
	return c[1]*x[2]^c[2] - x[1]
end
c = {1,1}; nc = #c -- Initial approximations. End of changes for most data sets
...
plot(xd,yres2,res,{"Residual vs X","X","Res"})
plot(ycalc,yres2,res,{"Residual vs Y","Y","Res"}); plot(xyp,xypn,{"CDF plot","Res","CDF"}) 
