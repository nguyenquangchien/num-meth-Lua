-- /* File list9_12.lua */ -- General file for data fitting, Parameter estimation 
...
ft = function(x,c) -- Define function to fit data
	return  c[1]+ (c[2]-c[1])*(1 + (c[3]*x[2])^c[4])^-(1-1/c[4]) - x[1]
end
c = {0,.4,1,2}; nc = #c -- Initial approximations. End of changes for most data sets
