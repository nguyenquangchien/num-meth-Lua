-- File list4_7.lua Program for the voltages of a Full Wave Rectifier
...
Vm = 15 -- Magnitude of source voltage -- change as desired
...
write_data("list4_7.dat",xa,v1,v2,v3,vout)
plot(xa,v3,vout)