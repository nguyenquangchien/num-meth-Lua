...
ni = 7.14e18; Un = 1.0 --5e20
Um = 5e20 -- 1.0 -- Use normalized value
xmax,ymax = 2*L, L
feqs = { -- Table of functions
	function(x,y,t,uxx,ux,u,uy,uyy,ut,utt,nt) -- General point
		D = D0 + D1*Un*u/ni
--if nt==1000 then print('D,u =',D,u) end		
		--return D*(uxx + uyy) - ut 
		return (uxx + uyy) +(D1*Un/ni)*(ux^2+uy^2)/D- ut/D 
	end,
