...
tvals = {0,{1.e-15,1.e-6},2,10,{-2e-4,-1e-4,0,1e-4,2e-4}} -- 20 steps/decade, save 2
s,st = pdeivbvqst({eq,efl,efr},tvals,x,v)
write_data('list12_12.dat',s)
write_data('list12_12t.dat',st)	
