...
tvals = {0,10,100,400,{0,.25,.5,.75,1}} 
s,st = pdeivbvt({eq,efl,efr},tvals,x,v,vp,vpp)
write_data(2,'list12_15_1.dat',s)
write_data(10,'list12_15t_1.dat',st)	
...
s,st = pdeivbvt({eq,efl,efr},tvals,x,v,vp,vpp)
write_data(2,'list12_15_2.dat',s)
write_data('list12_15t_2.dat',st)	
print('time taken for calculation = ',os.time()-tt); tt = os.time()
...
tvals = {0,10,100,40,{0,L/4,L/2,3*L/4,L}} 
s,st = pdeivbvt({eq,efl,efr},tvals,x,v,vp,vpp)
write_data(2,'list12_15_3.dat',s)
write_data('list12_15t_3.dat',st)	
print('time taken for calculation = ',os.time()-tt); tt = os.time()
