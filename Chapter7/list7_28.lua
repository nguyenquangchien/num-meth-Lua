-- /* File list7_28.lua */ Example of 1/y^2 weithting factor
...
fw = {}; for i=1,nd do fw[i] = (1000/yd[i])^2 end
...
dx = (xmax-xmin)/nx
xx,yy={},{}
x0 = 600 -- Initial guess at mobility
for i=1,nx do 
	xx[i] = xmin+dx*(i-1)
 	yy[i] = fft({0,xx[i]},c) -- Required for nonlinear function
end
plot(xx,yy)
write_data("list7_28.dat",xx,yy) -- Save data 
