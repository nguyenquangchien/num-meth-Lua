...
efl = function(fv,v,vp) -- Left boundary values, all zero
	fv[1], fv[2], fv[3] = v[1]-va, v[2]-va, v[3]-va
end
efr = function(fv,v,vp) -- Righr boundary values
	fv[1], fv[2], fv[3] = v[1] - vj, v[2], v[3]
end
...
for i=0,11 do
	...
	write_data('list11_27'..i..'.dat',s) -- Save solution
	if i>0 then x,v = xad(x,v) end -- Added statement
end
