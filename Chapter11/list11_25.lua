-- /* File list11_25.lua */ -- Solution of semiconductor device equations

require"odefd"
getfenv(odefd).nprint = 1 -- Print iterations if desired

-- Material and device parameters
q = 1.6e-19; eps = 11.9*8.854e-14; L = 2.e-4
vt = .026; ni = 1.45e10
Na = 1e16; Nd = 1.e19 -- Doping densities
tno = 1.e-12; tpo = 2.e-12 -- Lifetimes
n1 = ni; p1 = ni
...
print(nn); plot(s)
write_data('list11_25.dat',s) -- Save solution
